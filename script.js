...
const game = (() => {
	...
	const click = (e) => {
		if (matchOver != true) {
			...
			if (!box.classList.contains("played")) { //!box.classList.contains(player1.mark) && !box.classList.contains(player2.mark) && 
	...
	const checkWin = (arr, player) => {
		...
		/* console.log(winConditons.toString() == "x,x,x" || winConditons.toString() == "o,o,o") */ 
	}
	return { init, reset }
})()

const player1 = Players("Fire", "X");
